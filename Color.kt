...
// Define base colors for the app. These can be adjusted to fit the ScaffoldPRO brand.
...
val md_theme_dark_tertiaryContainer = Color(0xFF4C4263)
...
// Seed color for generating tonal palettes (optional, if using Material Theme Builder)
